"""
Modflow NWT version of the Green Valley example problem described in:
...
def build_model(name, model_ws):
    ...
    strk = 7.73e-05
    records =[
        (1, 1, 2, 0, 0, 0, 50.0, 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1093.048, 12, 0, 0, 0, 0, 0, strk, 3.0, 1077.408, 12, 0, 0, 0, 0, 0),
        (2, 1, 6, 0, 0, 0, 0.00, 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1071.934, 12, 0, 0, 0, 0, 0, strk, 3.0, 1052.359, 12, 0, 0, 0, 0, 0),
        (3, 1, 5, 0, 0, 0, 0.00, 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1073.636, 10, 0, 0, 0, 0, 0, strk, 3.0, 1060.545, 10, 0, 0, 0, 0, 0),
        (4, 1, 5, 0, 0, 0, 10.0, 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1077.727, 10, 0, 0, 0, 0, 0, strk, 3.0, 1063.182, 10, 0, 0, 0, 0, 0),
        (5, 1, 6, 0, 0, 0, 0.00, 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1058.000, 15, 0, 0, 0, 0, 0, strk, 3.0, 1046.250, 15, 0, 0, 0, 0, 0),
        (6, 1, 8, 0, 0, 0, 0.00, 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1042.727, 12, 0, 0, 0, 0, 0, strk, 3.0, 1025.909, 12, 0, 0, 0, 0, 0),
        (7, 1, 8, 0, 0, 0, 150., 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1037.581, 55, 0, 0, 0, 0, 0, 0.00006, 3.0, 1027.419, 55, 0, 0, 0, 0, 0),
        (8, 1, 0, 0, 0, 0, 0.00, 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1021.875, 40, 0, 0, 0, 0, 0, 0.00006, 3.0, 991.8750, 40, 0, 0, 0, 0, 0),
        (9, 1, 0, 2, 0, 0, 100., 0, 0, 0, 0.03, 0, 0, 0, 0, 0, 0.00003, 3.0, 1051.000, 4., 0, 0, 0, 0, 0, 0.00001, 3.0, 1050.000, 4., 0, 0, 0, 0, 0)
    ]
    ...
    for per in range(4, 49):
        irrwell[per] = irrwell[per - 1]# wel.copy()
        irrdiversion[per] = div.copy()
        supwell[per] = sup.copy()
